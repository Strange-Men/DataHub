...
P2-M8.1 local implementation and sealed-P1 regression are complete. Unified retrieval, RRF, shadow retrieval, Agent consumption, native image/multimodal embedding, real AI extraction, Phase 3, and Phase 4 must not be implemented early or outside separately authorized milestones. M8.2 remains blocked until Render persistent storage is attached/configured and the online P2 smoke/Eval gates pass.
