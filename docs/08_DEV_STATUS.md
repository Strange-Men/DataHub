...
P3-M2 is released and P3-M3.1 Draft Asset Schema Foundation is complete. P1/P2 remain formally frozen at the post-release patch baseline; CustomerOpsAgent remains P1-only by default, Unified remains explicit opt-in, Render P2 persistence remains BLOCKED, and local Docker remains the authoritative runtime boundary. P3 now has four additive tables: Project, governed Source Item, draft Asset Version and immutable Asset-Version Source snapshot. M3.1 adds no draft Repository, Service, API, generator, review, publish, export or frontend workflow. P3-M3.2 has not started.

The cumulative P1/P2 chronology below is historical. Any older “current checkpoint” wording is superseded by this P3-M3.1 status.
