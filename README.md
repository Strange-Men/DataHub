...
- P3-M2 项目与来源阶段已完成；P3-M3.1 已新增草稿资产版本与不可变来源快照两张表的 schema foundation。尚无草稿 Repository/Service/API 或生成逻辑，P3 页面仍显示“尚未开放”，P3-M3.2 与 P4 尚未开始。
